    ...
    render() {
        return (
            <Nav defaultActiveKey="/" className="sticky-top position-navbar pt-5 mt-5">
                ...
                <Nav.Item>
                    <Nav.Link as = {Link} to="/product" className="text-white mx-2"><FontAwesomeIcon icon={faUtensils} size="lg" className="mr-2"/> Manage Product</Nav.Link><hr className="bg-secondary mx-4"/>
                </Nav.Item>
                <Nav.Item>
